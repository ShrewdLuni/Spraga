...
export const FooterContacts = () => {
  return (
    <div className="flex flex-col gap-y-4">
      <p className="text-1xl lg:text-2xl font-semibold text-center lg:text-left transition-all duration-300">Contacts</p>
      ...
      <div className="flex flex-row gap-x-2 mt-4 justify-center lg:justify-start">
        <a href="" className="">
          <FaInstagram className="h-8 w-8 hover:text-[#C13584] transition-all duration-300"/>
        </a>
        <a href="">
          <FaSquareFacebook className="h-8 w-8 hover:text-[#2f55a4] transition-all duration-300"/>
        </a>
      </div>
    </div>
  )
